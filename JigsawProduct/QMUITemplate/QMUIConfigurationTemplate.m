...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarTitleFont = [UIFont systemFontOfSize:17];                                              // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
    ...
    QMUICMI.navBarBackIndicatorImage = [UIImage imageNamed:@"icon_select_fanhui"];                                     // NavBarBackIndicatorImage : 导航栏的返回按钮的图片，图片尺寸建议为(13, 21)，否则最终的图片位置无法与系统原生的位置保持一致
